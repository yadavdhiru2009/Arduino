/***************************************************************************
* Example sketch for the INA226_DP library
*
 ...
 * INA226_DP ina226 = INA226_DP(); -> uses I2C Address = 0x40 / Wire
 * INA226_DP ina226 = INA226_DP(I2C_ADDRESS);   
 * INA226_DP ina226 = INA226_DP(&Wire); -> uses I2C_ADDRESS = 0x40, pass any Wire Object
 * INA226_DP ina226 = INA226_DP(&Wire, I2C_ADDRESS); 
 */
INA226_DP ina226 = INA226_DP(I2C_ADDRESS);
